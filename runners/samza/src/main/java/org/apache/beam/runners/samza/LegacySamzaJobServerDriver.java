...
public class LegacySamzaJobServerDriver {
  private static final Logger LOG = LoggerFactory.getLogger(LegacySamzaJobServerDriver.class);

  private final SamzaPortablePipelineOptions pipelineOptions;

  protected LegacySamzaJobServerDriver(SamzaPortablePipelineOptions pipelineOptions) {
  ...
  public static LegacySamzaJobServerDriver fromOptions(SamzaPortablePipelineOptions pipelineOptions) {
    ...
    return new LegacySamzaJobServerDriver(pipelineOptions);
  }
